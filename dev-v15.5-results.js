...
function enhanceAll(){document.querySelectorAll('.gr-mission').forEach(enhanceCard);document.querySelectorAll('.gr155-upload-status').forEach(x=>x.remove());enhancePlatoonRecap()}
